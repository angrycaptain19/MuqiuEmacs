...
Same as `spiral-connect' but force a prompt so the user can decide where to connect." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "spiral-util" '("comment" "spiral-")))

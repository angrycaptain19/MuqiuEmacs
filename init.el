(custom-set-variables
 ...
 '(package-selected-packages
   '(english-teacher ir-black-theme ccls indent-guide rainbow-delimiters spiral lsp-mode counsel vterm dashboard bshell rust-mode hy-mode jquery-doc treemacs evil org-pomodoro org-bullets magit w3m osx-browse doom-modeline doom-themes material-theme zygospore helm-gtags helm yasnippet ws-butler volatile-highlights use-package undo-tree iedit dtrt-indent counsel-projectile company clean-aindent-mode anzu))
 '(rustic-ansi-faces
...
(use-package dashboard
  ...
  (setq dashboard-banner-logo-title "Muqiu-Han's Emacs"
        dashboard-startup-banner "~/图片/EmacsLogo.png"
